...
import com.example.shopster.ViewHolder.ProductAdapter;
import com.example.shopster.ViewHolder.SliderAdapter;
import com.example.shopster.constant.Constant;
import com.example.shopster.MenuFiles.BaseActivity;
import com.example.shopster.MenuFiles.CartActivity;
import com.example.shopster.MenuFiles.SearchActivity;
...
//        prodMap.put("description","6 GB RAM\n128 GB ROM\n Expandable upto 1TB\n 16.76 cm Full HD+ Display \n 4500mAH Battery (non-removable)\nNightspace\nCorning Gorilla glass3 protection\nwith wide angle camera and many more");
